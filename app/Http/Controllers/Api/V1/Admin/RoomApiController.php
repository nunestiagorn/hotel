...
class RoomApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new RoomResource(Room::with(['hotel', 'room_type'])->get());
    }
    ...
    public function store(StoreRoomRequest $request)
    {
        ...
        if ($request->input('image', false)) {
            $room->addMedia(storage_path('tmp/uploads/' . $request->input('image')))->toMediaCollection('image');
        }
    ...
    public function show(Room $room)
    {
        ...
        return new RoomResource($room->load(['hotel', 'room_type']));
    }
